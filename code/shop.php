	...
	<div class="bg0 m-t-23 p-b-140" style="margin-top: 80px;">
		<div class="container">
			...
			<!-- end of filter  -->
				...
				<?php $conn = new mysqli('localhost', 'root', '','e_commerce');
				// Check connection
            ...
            <?php  
			$sql = "SELECT * FROM products WHERE product_tag='women'";
				$result = mysqli_query($conn, $sql);
				$product = mysqli_fetch_all($result, MYSQLI_ASSOC);
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php?id=<?php $val['product_id'] ; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
			...
			$sql = "SELECT * FROM products WHERE product_tag='sales'";
               ...
               ?>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item sales">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?php echo $val['product_main_image'] ;?>">
           ...
           <?php  }?>
            ...
            <?php  
			$sql = "SELECT * FROM products WHERE product_tag='men'";
				$result = mysqli_query($conn, $sql);
				$product = mysqli_fetch_all($result, MYSQLI_ASSOC);
               ...
               ?>
				...
				<?php  
			    $sql = "SELECT * FROM products WHERE product_tag='watches'";
				$result = mysqli_query($conn, $sql);
				$product = mysqli_fetch_all($result, MYSQLI_ASSOC);
               ...
               ?>
				...
				<?php  
			    $sql = "SELECT * FROM products WHERE product_tag='shoes'";
				$result = mysqli_query($conn, $sql);
				$product = mysqli_fetch_all($result, MYSQLI_ASSOC);
